<template>
  <div class="position-relative">
    <Swiper class="homePage-Swiper" :slides-per-view="1" :space-between="50" :modules="modules" loop
      ...
      <SwiperSlide>
        <div class="slide-content" style="background-image: url('src/assets/images/homepage/background1.jpg');"></div>
      </SwiperSlide>
      <SwiperSlide>
        <div class="slide-content" style="background-image: url('src/assets/images/homepage/background2.jpg');"></div>
      </SwiperSlide>
      <SwiperSlide>
        <div class="slide-content" style="background-image: url('src/assets/images/homepage/background3.jpg');"></div>
      </SwiperSlide>
      <SwiperSlide>
        <div class="slide-content" style="background-image: url('src/assets/images/homepage/background4.jpg');"></div>
      </SwiperSlide>
      <SwiperSlide>
        <div class="slide-content" style="background-image: url('src/assets/images/homepage/background5.jpg');"></div>
      </SwiperSlide>
